    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-sm">
        ...
        <div className="flex mb-8 border-b border-gray-200">
          ...
          <button
            className={`flex-1 py-3 text-base font-medium transition-all duration-300 ${
              activeTab === "mentor"
                ? "text-teal-600 border-b-2 border-teal-600"
                : "text-gray-500 hover:text-gray-700"
            }`}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-teal-600 text-white py-3 mb-5 px-4 rounded-md hover:bg-teal-700 transition-colors font-medium"
          >
            Log in
          </button>
        </form>
        ...
        {/* <button className="w-full flex items-center justify-center border border-gray-300 py-3 px-4 rounded-md hover:bg-gray-50 transition-colors mb-6">
          <Image
            src={GoogleIcon}
            alt="Google"
            width={20}
